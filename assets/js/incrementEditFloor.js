...
function initializeStepper(container = document) {
    ...
    container.querySelectorAll('.bv4zwx4').forEach(function(button) {
...
function handleStepperClick() {
    var input = this.closest('.bkl6b1x').querySelector('.input-stepper-item');
...
function updateButtonState(input) {
    var decrementButton = input.closest('.bkl6b1x').querySelector('.bv4zwx4[id*="decrement"]');
